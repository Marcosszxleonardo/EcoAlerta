            ...
            <main className="mainContent">
                ...
                <div className="registroContainer">
                    <div className="registroCard">
                        {/* Cabeçalho com usuário e botão Enviar à direita */}
                        <div className="postHeader">
                            <div className="userInfo">
                                <FaUserCircle className="userIcon" />
                                <div>
                                    <h2>João</h2>
                                    <p>Adicione uma descrição do desastre urbano para o seu post.</p>
                                </div>
                            </div>
                        ...
                        <div className="opcoes">
                            <div className="opcaoCard" onClick={pegarLocalizacao}>
                                ...
                                <p>Use sua localização atual para marcar o alerta no mapa.</p>
                            </div>
                            ...
                            <div className="opcaoCard">
                                ...
                                <p>Adicione fotos para ajudar a demonstrar a situação.</p>
                            </div>
                        </div>
                    </div>
                </div>
